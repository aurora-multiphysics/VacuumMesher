...
libMesh::Mesh &MeshPair::libmeshMesh() { return *libmeshMesh_; }

Eigen::MatrixXd &MeshPair::iglVerts() { return iglVerts_; }

Eigen::MatrixXi &MeshPair::iglElems() { return iglElems_; }
