...
class MeshContainer{
    ...
    public: 
        ...
        // Most commonly called constructor; Takes in libMesh::Init object to instantiate meshes
        ...
        std::string path_, meshFilename_, skinFilename_, boundFilename_, vacuumFilename_;
    ...
    // private:
        ...
        //  which elements are on the boundary between the vacuum and the original mesh
